...
const Section = ({ hook, title, content }: SectionProps) => {
  return (
    <section ref={hook} className='flex flex-col gap-6'>
      <h2 className=' frutiger text-center text-[1.125rem] md:text-2xl font-bold bg-[rgba(255,255,255,0.125)] border border-[rgba(255,255,255,0.5)] rounded-2xl p-2 shadow-[0px_6px_3px_rgba(0,0,0,0.2)]'>{title}</h2>
...
const Main = ({ homeRef, aboutRef, projectsRef, contactsRef }: RefProps) => {
  return (
    <main className='flex flex-col gap-6 overflow-y-auto rounded-2xl [scrollbar-width:none] [&::-webkit-scrollbar]:hidden max-md:pb-2' >
